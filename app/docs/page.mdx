...
It's a simple REST API—no vendor lock-in, no complex SDKs. If your system can make HTTP requests, it can use MemVault.
...
1. **[Quick Start Guide](/docs/quickstart)** - Get up and running in 5 minutes
2. **[Authentication](/docs/authentication)** - Learn how to secure your API requests
3. **[Architecture Deep Dive](/docs/architecture)** - Understand how Sleep Cycles work
4. **[API Reference](/docs/api/store-memory)** - Complete API documentation
...
**Questions?** Check out our [API Reference](/docs/api/store-memory) or contact support at support@memvault.com.
